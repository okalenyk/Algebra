...
# from backend.consts import TOKEN_ERROR
...
# def _get_actual_token_image(address: str, network_title: str) -> str:
#     return f'{settings.MAIN_BACKEND}/assets/{network_title}/{address}/logo.png'
